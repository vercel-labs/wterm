...
- **Local session reconnection** — brief connection interruptions resume the same shell and terminal state in the existing page, with bounded output replay and no automatic input retries
