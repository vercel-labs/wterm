...
- **In-browser Bash shell** — optional just-bash adapter with Unicode-aware line editing, command history that preserves unfinished input, tab completion, Home/End and Delete editing, and word-wise cursor movement
