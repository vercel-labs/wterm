...
<div className="mb-12">
  ...
  <div className="mb-8 hidden text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 md:block">
    wterm <span className="text-neutral-400 dark:text-neutral-500">(pronounced "dub-term")</span> is a terminal emulator whose core is written in Zig and compiled to WASM for near-native performance in the browser. Rendering uses the DOM — native text selection, copy/paste, find, and accessibility come for free.
  </div>
