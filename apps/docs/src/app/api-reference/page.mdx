...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>writeString(str)</code>
      </td>
      <td>Write a UTF-8 string (including escape sequences) to the terminal</td>
    </tr>
    <tr>
      <td>
        <code>writeRaw(data: Uint8Array)</code>
      </td>
      <td>
        Write raw bytes to the terminal (chunked to 8192 bytes internally)
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      ...
      <td>
        Get pending host response (e.g. DSR), or <code>null</code>. Reading
        clears the buffer.
      </td>
    </tr>
    <tr>
