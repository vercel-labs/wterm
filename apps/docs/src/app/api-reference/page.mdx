...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Focus the hidden textarea after initialization</td>
    </tr>
    <tr>
      <td>
        <code>focusOnClick</code>
      </td>
      <td>
        <code>boolean</code>
      </td>
      ...
      <td>Focus the hidden textarea when the terminal is clicked</td>
    </tr>
    <tr>
      <td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Scroll the DOM viewport to the bottom of scrollback</td>
    </tr>
    <tr>
      <td>
        <code>destroy()</code>
