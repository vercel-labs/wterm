...
WTerm renders synchronized output blocks (CSI `?2026`) atomically when the mode closes. An unterminated block falls back to normal painting after one second of inactivity.
