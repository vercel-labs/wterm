  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        the built-in Zig WASM binary. See <a href="/ghostty">Ghostty Core</a>{" "}
        for an example.
      </td>
    </tr>
    <tr>
      ...
      <td>
        ...
        is decoded from an inlined base64 string. Ignored when <code>core</code>{" "}
        is provided.
      </td>
    </tr>
    <tr>
      ...
      <td>
        <code>true</code> (vanilla) / <code>false</code> (React, Vue)
      </td>
      <td>
    ...
    <tr>
      ...
      <td>
        Enable inline image rendering via the{" "}
        <a href="https://sw.kovidgoyal.net/kitty/graphics-protocol/">
          Kitty terminal graphics protocol
        </a>
        . APC <code>{"\\x1b_G…\\x1b\\\\"}</code> sequences are intercepted and
        rendered as <code>&lt;img&gt;</code> overlays above the cell grid. Set
        to <code>false</code> to pass the bytes through to the core unchanged.
      </td>
    </tr>
    <tr>
      <td>
