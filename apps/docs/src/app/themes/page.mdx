...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Terminal background color</td>
    </tr>
    <tr>
      <td>
        <code>--term-fg</code>
    ...
    <tr>
      <td>
        <code>--term-cursor</code>
      </td>
      <td>Cursor color</td>
    </tr>
    <tr>
      <td>
        <code>--term-font-family</code>
      </td>
      <td>
        Font stack (default: Menlo, Consolas, DejaVu Sans Mono, Courier New,
        monospace)
      </td>
    </tr>
    <tr>
      <td>
        <code>--term-font-size</code>
      </td>
      <td>
        Font size (default: <code>14px</code>)
      </td>
    </tr>
    <tr>
      <td>
        <code>--term-line-height</code>
      </td>
      <td>
        Line height multiplier (default: <code>1.2</code>)
      </td>
    </tr>
    <tr>
      <td>
        <code>--term-color-0</code> … <code>--term-color-7</code>
      </td>
      <td>
        Standard ANSI colors (black, red, green, yellow, blue, magenta, cyan,
        white)
      </td>
    </tr>
    <tr>
      <td>
        <code>--term-color-8</code> … <code>--term-color-15</code>
      </td>
      <td>Bright ANSI colors</td>
    </tr>
  </tbody>
</table>
