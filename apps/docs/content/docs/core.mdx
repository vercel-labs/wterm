...
With `@wterm/dom`, terminal applications can enable SGR mouse tracking (modes 1000, 1002, 1003, and 1006) and focus reporting (mode 1004). Mode 1003 reports pointer motion without a pressed button once per cell in the visible grid. Pointer and focus reports are emitted through `onData`.
