...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Active mouse wire format: <code>x10</code>, <code>utf8</code>, <code>sgr</code>, <code>urxvt</code>, or <code>sgr-pixels</code>. Optional for custom cores. The DOM layer sends the first four formats; pixel reports are not sent.</td>
    </tr>
    <tr>
