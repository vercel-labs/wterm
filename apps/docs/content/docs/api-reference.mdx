...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Active mouse wire format: <code>x10</code>, <code>utf8</code>, <code>sgr</code>, <code>urxvt</code>, or <code>sgr-pixels</code>. Optional for custom cores; the built-in core returns <code>x10</code> or <code>sgr</code>.</td>
    </tr>
    <tr>
