...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Read selected rendered text with terminal line and cell semantics, or null when unavailable</td>
    </tr>
  </tbody>
</table>
...
Selection is native and covers mounted text. This method does not select all retained history or track selection through reflow. Unchanged renders preserve text nodes; row replacement, resizing, and history pruning can change or clear a selection.
