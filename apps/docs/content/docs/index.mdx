...
<div className="mb-12">
  <div className="mb-8 hidden text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 md:block">
    wterm <span className="text-neutral-500 dark:text-neutral-400">("dub-term")</span> renders to the DOM — native text selection, copy/paste, find, and accessibility come for free. Try the Ghostty-powered terminal below.
  </div>
  <div className="mb-6 md:mb-0">
    <HeroSection />
  </div>
  <div className="mt-4 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 md:hidden">
    wterm <span className="text-neutral-500 dark:text-neutral-400">("dub-term")</span> renders to the DOM — native text selection, copy/paste, find, and accessibility come for free. Try the Ghostty-powered terminal above.
  </div>
  <div className="mt-3 text-xs text-neutral-500 dark:text-neutral-400">
    The interactive example uses the <a href="/ghostty" className="underline underline-offset-2 hover:text-neutral-700 dark:hover:text-neutral-300">Ghostty core</a> and <a href="https://github.com/vercel-labs/just-bash" className="underline underline-offset-2 hover:text-neutral-700 dark:hover:text-neutral-300">just-bash</a>. See also: <a href="https://github.com/vercel-labs/wterm/tree/main/examples/ssh" className="underline underline-offset-2 hover:text-neutral-700 dark:hover:text-neutral-300">SSH</a>, <a href="https://github.com/vercel-labs/wterm/tree/main/examples/local" className="underline underline-offset-2 hover:text-neutral-700 dark:hover:text-neutral-300">local</a>.
  </div>
</div>

## Features

- **Pluggable cores** — a lightweight Zig/WASM core or Ghostty VT emulation for richer terminal compatibility
...
- **IME composition** — tentative text appears at the cursor; only committed text reaches the application
