...
# this when the host toolchain cannot build with Zig 0.16.x (required by the
# pinned post-#13394 ghostty snapshot). The wasm build itself is fine; only
# host-native steps can break.
#
