...
| [`@wterm/vue`](https://www.npmjs.com/package/@wterm/vue) | Vue 3 component + `useTerminal` composable |
| [`@wterm/svelte`](https://www.npmjs.com/package/@wterm/svelte) | Svelte action + imperative terminal controller |
