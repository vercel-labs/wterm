...
Input accessibility cases cover named editable controls, readable mounted output, live ARIA label/description changes, tab-order ownership, hidden terminals, and teardown across all three browser engines.
